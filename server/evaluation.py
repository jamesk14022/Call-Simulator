    ...
    completion_result = (
        get_completion(
            [
                {
                    "role": "system",
                    "content": is_resolved_prompt.format(
                        transcription=input_call.transcription
                    ),
                }
            ],
            json=True,
...
def check_polite_advisor(input_call: Call):
    completion_result = (
        get_completion(
            [
                {
                    "role": "system",
                    "content": is_polite_prompt.format(
                        transcription=input_call.transcription
                    ),
                }
            ],
    ...
    json_completion = json.loads(completion_result)
    return (
        json_completion["is_polite"],
        json_completion["explanation"],
        json_completion["feedback"],
    )
    ...
    completion_result = (
        get_completion(
            [
                {
                    "role": "system",
                    "content": confirm_intention_prompt.format(
                        transcription=input_call.transcription
                    ),
                }
            ],
...
def check_confirm_no_further(input_call: Call):
    completion_result = (
        get_completion(
            [
                {
                    "role": "system",
                    "content": confirm_no_further_prompt.format(
                        transcription=input_call.transcription
                    ),
                }
            ],
    ...
    json_completion = json.loads(completion_result)
    return (
        json_completion["confirmed_is_no_further"],
        json_completion["explanation"],
        json_completion["feedback"],
    )
